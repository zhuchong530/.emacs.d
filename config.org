  ...
  (defun my/setup-fonts ()
    (cond
     ...
     ((eq system-type 'gnu/linux)
      (if (find-font (font-spec :name "Monaspace Krypton"))
          (set-face-attribute 'default nil :family "Monaspace Krypton" :height 170)
        (set-face-attribute 'default nil :family "DejaVu Sans Mono" :height 160)))))

  (if (daemonp)
      (add-hook 'server-after-make-frame-hook (lambda (frame) (with-selected-frame frame (my/setup-fonts))))
    (my/setup-fonts))
...
#+begin_src emacs-lisp
  (use-package vertico-posframe
    ...
    (setq vertico-posframe-width 160
          ...
          vertico-posframe-auto-height t))
#+end_src
