...
(custom-set-variables
 ...
 '(package-selected-packages
   '(all-the-icons-ivy-rich counsel counsel-gtags ivy swiper vertico corfu orderless marginalia org-roam org-roam-ui nyan-mode gcmh all-the-icons-dired rainbow-fart centaur-tabs flycheck-rust cargo rustic youdao-dictionary ace-window yasnippet-snippets indent-guide all-the-icons company-tabnine go-eldoc rainbow-delimiters go-mode bug-hunter undo-tree lsp-python-ms lsp-mode lsp-ui doom-modeline zeal-at-point cmake-ide cmake-mode diminish web-mode flycheck-go projejctile ws-butler which-key volatile-highlights use-package switch-window smartparens rainbow-mode python-mode powerline nasm-mode multi-web-mode magit js2-mode iedit highlight-symbol golden-ratio function-args exec-path-from-shell duplicate-thing comment-dwim-2 color-theme clean-aindent-mode anzu ace-jump-mode)))
(custom-set-faces
