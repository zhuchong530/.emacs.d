...
[[https://github.com/emacs-eaf/emacs-application-framework/blob/master/README.zh-CN.md][README]]
...
#+begin_src emacs-lisp
  (use-package eaf
    ...
    (eaf-browser-continue-where-oeft-off t)
